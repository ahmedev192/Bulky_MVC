...
new Product { Id = 10, Title = "Kitab al-Tawhid", Description = "A book on the oneness of God by Muhammad ibn Abd al-Wahhab.", ISBN = "9789960897313", Author = "Muhammad ibn Abd al-Wahhab", ListPrice = 19.99, Price = 17.99, Price50 = 16.99, Price100 = 15.99, CategoryId = 1/*, ImageUrl = "/images/products/Kitab al-Tawhid.jpg"*/ }
            ...
            modelBuilder.Entity<ProductImage>().HasData(
                 new ProductImage { Id = 1, ProductId = 1, ImageUrl = "/Images/Products/riyad-salehen.jpg"  },
                 new ProductImage { Id = 2, ProductId = 2, ImageUrl = "/Images/Products/Al-Adab Al-Mufrad.jpg" },
                 new ProductImage { Id = 3, ProductId = 3, ImageUrl = "/Images/Products/Ihya Ulum al-Din.jpg" },
                 new ProductImage { Id = 4, ProductId = 4, ImageUrl = "/Images/Products/Sahih al-Bukhari.jpg" },
                 new ProductImage { Id = 5, ProductId = 5, ImageUrl = "/Images/Products/Al-Muwatta.jpg" },
                 new ProductImage { Id = 6, ProductId = 6, ImageUrl = "/Images/Products/Tafsir al-Jalalayn.png" },
                 new ProductImage { Id = 7, ProductId = 7, ImageUrl = "/Images/Products/Fath al-Bari.jpg" },
                 new ProductImage { Id = 8, ProductId = 8, ImageUrl = "/Images/Products/The Forty Hadith.jpg" },
                 new ProductImage { Id = 9, ProductId = 9, ImageUrl = "/Images/Products/The Purification of the Soul.jpg" },
                 new ProductImage { Id = 10, ProductId = 10, ImageUrl = "/Images/Products/Kitab al-Tawhid.jpg" },
                     new ProductImage { Id = 11, ProductId = 1, ImageUrl = "/Images/Products/riyad-salehen.jpg" },
                 new ProductImage { Id = 12, ProductId = 2, ImageUrl = "/Images/Products/Al-Adab Al-Mufrad.jpg" },
                 new ProductImage { Id = 13, ProductId = 3, ImageUrl = "/Images/Products/Ihya Ulum al-Din.jpg" },
                 new ProductImage { Id = 14, ProductId = 4, ImageUrl = "/Images/Products/Sahih al-Bukhari.jpg" },
                 new ProductImage { Id = 15, ProductId = 5, ImageUrl = "/Images/Products/Al-Muwatta.jpg" },
                 new ProductImage { Id = 16, ProductId = 6, ImageUrl = "/Images/Products/Tafsir al-Jalalayn.png" },
                 new ProductImage { Id = 17, ProductId = 7, ImageUrl = "/Images/Products/Fath al-Bari.jpg" },
                 new ProductImage { Id = 18, ProductId = 8, ImageUrl = "/Images/Products/The Forty Hadith.jpg" },
                 new ProductImage { Id = 19, ProductId = 9, ImageUrl = "/Images/Products/The Purification of the Soul.jpg" },
                 new ProductImage { Id = 20, ProductId = 10, ImageUrl = "/Images/Products/Kitab al-Tawhid.jpg" },
                     new ProductImage { Id = 21, ProductId = 1, ImageUrl = "/Images/Products/riyad-salehen.jpg" },
                 new ProductImage { Id = 22, ProductId = 2, ImageUrl = "/Images/Products/Al-Adab Al-Mufrad.jpg" },
                 new ProductImage { Id = 23, ProductId = 3, ImageUrl = "/Images/Products/Ihya Ulum al-Din.jpg" },
                 new ProductImage { Id = 24, ProductId = 4, ImageUrl = "/Images/Products/Sahih al-Bukhari.jpg" },
                 new ProductImage { Id = 25, ProductId = 5, ImageUrl = "/Images/Products/Al-Muwatta.jpg" },
                 new ProductImage { Id = 26, ProductId = 6, ImageUrl = "/Images/Products/Tafsir al-Jalalayn.png" },
                 new ProductImage { Id = 27, ProductId = 7, ImageUrl = "/Images/Products/Fath al-Bari.jpg" },
                 new ProductImage { Id = 28, ProductId = 8, ImageUrl = "/Images/Products/The Forty Hadith.jpg" },
                 new ProductImage { Id = 29, ProductId = 9, ImageUrl = "/Images/Products/The Purification of the Soul.jpg" },
                 new ProductImage { Id = 30, ProductId = 10, ImageUrl = "/Images/Products/Kitab al-Tawhid.jpg" }
             );
